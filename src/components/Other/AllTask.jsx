...
const AllTask = () => {
  ...
  return (
    <div className='bg-[#1c1c1c] p-5 mt-5 rounded h-[40vh]'>
      <div className='font-semibold mb-2 text-zinc-400 py-2 px-4 flex justify-between items-center rounded'>
      ...
      {employeeData && employeeData.map((elem,index)=>{
        return <div key={index} className='border-2 text-xl border-zinc-600 mb-2 py-2 px-4 flex justify-between items-center rounded'>
